                    ...
                    <div class="card keranjang" style="width: 18rem; position: sticky; top: 50px;">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                <button class="btn btn-info text-white" style="font-size: 70%;" onclick="window.location.href='./view/keranjang.php';">Masukkan Keranjang</button>
                                <button class="btn btn-info text-white" style="font-size: 70%;" onclick="window.location.href='./view/keranjang.php';">Beli Langsung</button>
                            </div>
                        </div>
                    </div>
                </div>
